...
class Mux: public Blockio<N,1,T,eeros::math::Matrix<N,1,T>,MakeUnitArray<U,N>::value,MakeUnitArray<U>::value> {
 public:
  /**
...
std::ostream& operator<<(std::ostream& os, const Mux<N, T, U>& m) {
