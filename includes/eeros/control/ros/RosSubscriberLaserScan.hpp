...
class RosSubscriberLaserScan : public RosSubscriber<sensor_msgs::msg::LaserScan::Type, double> {
 ...
 public:
  ...
  void rosCallbackFct(const TRosMsg& msg) {
    ...
    // cast because axes is a float32 vector
    std::vector<double> rangesTmp( msg.ranges.begin(), msg.ranges.end() );
    ...
    // cast because axes is a float32 vector
    std::vector<double> intensitiesTmp( msg.intensities.begin(), msg.intensities.end() );
