#ifndef ORG_EEROS_SOCKET_CONNECTION_HPP_
#define ORG_EEROS_SOCKET_CONNECTION_HPP_
...
namespace eeros {
	namespace sockets {
		...
		class SocketConnection : public eeros::Thread {

		public:
			
			SocketConnection(uint16_t port, int byteSize = 4, double periodInSec = 0.01);
...
#endif // ORG_EEROS_SOCKET_CONNECTION_HPP_