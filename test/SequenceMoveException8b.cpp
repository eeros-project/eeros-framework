...
SequenceMoveException8b::SequenceMoveException8b(std::string name, eeros::sequencer::Sequencer& caller)
	: NonBlockingSubSequence_ErrorHandler(name, caller){
}

SequenceMoveException8b::~SequenceMoveException8b(void){
}

void SequenceMoveException8b::moveException(){
	...
	if(i == 0) {
		...
		throw new eeros::sequencer::SequenceException(this, static_cast<eeros::sequencer::Sequence::method>(&SequenceMoveException8b::moveException),
							      static_cast<eeros::sequencer::Sequence::method>(&NonBlockingSubSequence_ErrorHandler::homed),
