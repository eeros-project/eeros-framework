...
SequenceMoveException2b::SequenceMoveException2b(std::string name, eeros::sequencer::Sequencer& caller)
	: SequenceMoveException1_3(name, caller) {
}
	
SequenceMoveException2b::~SequenceMoveException2b(){
}

void SequenceMoveException2b::moveException(){
	...
	if(i == 0) {
		...
		throw new eeros::sequencer::SequenceException(this, static_cast<eeros::sequencer::Sequence::method>(&SequenceMoveException2b::moveException), 
							      static_cast<eeros::sequencer::Sequence::method>(&SequenceMoveException2b::homed),
