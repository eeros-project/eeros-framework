...
//   int testNo = 1;
//
//   Matrix<3, 3, int> matZeros1, matZeros2, matOnes, matTwos, matThrees,
//       matSingleOne, matNegative;
//
//   matZeros1.zero();
//   matZeros2.zero();
//   matOnes << 1, 1, 1, 1, 1, 1;
...
//
//   std::cout << "    #" << testNo++ << ": Comparing two zero matrices"
//             << std::endl;
//   error = 0;
//   if (!(matZeros1 == matZeros2)) {
//     std::cout
//         << "    -> Failure: comparision is negative, but should be positive"
//         << std::endl;
//     error++;
//   }
//   errorSum += error;
...
//
//   std::cout << "    #" << testNo++
//             << ": Comparing a two complete different matrices" << std::endl;
//   error = 0;
//   if (matOnes == matTwos) {
//     std::cout
//         << "    -> Failure: comparision is positive, but should be negative"
//         << std::endl;
//     error++;
//   }
//   errorSum += error;
...
//
//   std::cout << "    #" << testNo++
//             << ": Comparing a two matrices, where only one element is different"
//             << std::endl;
//   error = 0;
...
//
//   std::cout << "    #" << testNo++
//             << ": Comparing two matrices where the elements have only a "
//                "different sign"
//             << std::endl;
//   error = 0;
...
//
//   std::cout << "    #" << testNo++
//             << ": Comparing a zeros matrix with a ones matrix" << std::endl;
//   error = 0;
...
//
//   std::cout << "    #" << testNo++
//             << ": Comparing a zeros matrix with a matrix with a single one"
//             << std::endl;
//   error = 0;
