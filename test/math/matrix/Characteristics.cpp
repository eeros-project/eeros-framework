...
int testSwapingRows(){
	...
	if(testMatrix1 != refResult1) {
		std::cout << "    -> Failure in result of test matrix 1, rwos were not correctly swapped!" << std::endl;
		error++;
	}
	
	if (testMatrix2 != refRestult2){
		std::cout << "    -> Failure in result of test matrix 2, rwos were not correctly swapped!" << std::endl;
		error++;
	}
	return error;
}
...
int testGaussSorting() {
	...
	if(testMatrix1 != refResult1) {
		std::cout << "    -> Failure in result of test matrix 1, matrix not correctly sorted!" << std::endl;
		error++;
	}
	
	if(testMatrix2 != refResult2) {
		std::cout << "    -> Failure in result of test matrix 2, matrix not correctly sorted!" << std::endl;
		error++;
	}
	
	if(testMatrix3 != refResult3) {
		std::cout << "    -> Failure in result of test matrix 3, matrix not correctly sorted!" << std::endl;
		error++;
	}
	if(testMatrix4 != refResult4) {
		std::cout << "    -> Failure in result of test matrix 4, matrix not correctly sorted!" << std::endl;
		error++;
	}
	if(testMatrix5 != refResult5) {
		std::cout << "    -> Failure in result of test matrix 5, matrix not correctly sorted!" << std::endl;
		error++;
	}
	
	if(testMatrix6 != refResult6) {
		std::cout << "    -> Failure in result of test matrix 6, matrix not correctly sorted!" << std::endl;
		error++;
	}
	return error;
}
