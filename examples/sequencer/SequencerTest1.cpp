...
public:
	MainSequence(std::string name, Sequencer& seq) : Sequence(name, seq), seqA("seq A", seq, this), seqB("seq B", seq, this), abortMonitor(this, &abortCondition, SequenceProp::abortOwner) { 
		setNonBlocking();
