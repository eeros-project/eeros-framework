...
class MyControlSystem {
 public:
  ...
  // ROS blocks
  typedef Matrix< 5, 1, double >		TRangesOutput;
  typedef Matrix< 5, 1, double >		TIntensitiesOutput;
  RosSubscriberLaserScan<TRangesOutput, TIntensitiesOutput>	laserScanIn;
  typedef Matrix< 5, 1, double >		TRangesInput;
  typedef Matrix< 5, 1, double >		TIntensitiesInput;
